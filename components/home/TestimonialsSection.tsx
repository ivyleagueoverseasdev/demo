    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-slate-100">
          ...
          <span className="font-jakarta text-xs font-semibold text-primary-600 truncate">{t.uni}</span>
        </div>
      </div>
    </motion.div>
  );
    ...
    >
      ...
      <div className="container-xl mt-10">
        ...
        >
          ...
          <Link
            href="/contact"
            className="font-jakarta text-xs font-bold px-5 py-2.5 rounded-xl bg-primary-600 text-white hover:bg-primary-700 transition-colors flex-shrink-0"
          >
            Book Free Session →
          </Link>
        </motion.div>
