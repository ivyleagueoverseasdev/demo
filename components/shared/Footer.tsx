...
const SOCIAL = [
  ...
  {
    label: 'Instagram',
    href:  'https://instagram.com/ivyleagueoverseas',
    icon:  (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
  ...
  {
    label: 'LinkedIn',
    href:  'https://linkedin.com/company/ivyleagueoverseas',
    icon:  (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      ...
      <div className="container-xl pt-14 pb-10 grid grid-cols-2 md:grid-cols-12 gap-10 lg:gap-14">
        ...
        <div className="col-span-2 md:col-span-4">
          ...
          <div className="space-y-2.5 text-sm">
            <a href={`tel:${COMPANY.phone}`} className="flex items-center gap-2.5 text-white/55 hover:text-white transition-colors">
              <span className="text-base">📞</span>
              <span>{COMPANY.phone}</span>
            </a>
            <a href={`mailto:${COMPANY.email}`} className="flex items-center gap-2.5 text-white/55 hover:text-white transition-colors">
              <span className="text-base">✉️</span>
              <span>{COMPANY.email}</span>
            </a>
            <a href={COMPANY.mapsLink} target="_blank" rel="noopener noreferrer" className="flex items-start gap-2.5 text-white/55 hover:text-amber-400 transition-colors">
