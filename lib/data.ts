import type { Country2026, Testimonial, Stat, SiteEvent, SiteMedia, ServiceItem, ProcessStepItem } from './types';
...
export const COMPANY = {
  ...
  wa:        'https://wa.me/919158577707?text=Hi%20Rajib%20Sir!%20%F0%9F%91%8B%20I%20am%20browsing%20your%20new%20platform%20and%20want%20to%20learn%20more%20about%20ILOC%27s%20services.',
...
export const DEFAULT_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    desc:  'One direct session with Rajib Paul, founder and lead counsellor. Get an honest assessment of your profile, the right country-university fit, and a scholarship strategy. No sales pitch. No hidden fees. Just a clear roadmap.',
  },
];
...
export const DEFAULT_PROCESS_STEPS: ProcessStepItem[] = [
  {
    ...
    desc:  'Book a 30-minute, zero-pressure session with Rajib Paul. We conduct an honest profile evaluation, identify your strongest country-university fit, and hand you a clear scholarship strategy — before you spend a single rupee.',
  },
  {
    step:  2,
    icon:  '📋',
